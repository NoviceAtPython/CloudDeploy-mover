...
run_apply() {
    ...
    log "  ubuntu-upgrade, base-packages, nvidia-driver, cuda, edid"
    log ""
    ...
    log "  KDE/KWin install, patched-KWin NVIDIA private HDR build,"
    log "  Sunshine fork build, Tailscale, PipeWire virtual sink,"
    log "  KWin/Plasma/Sunshine systemd units,"
